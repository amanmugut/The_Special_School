...
public class MatchHindiChapThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_hindi_chap_three);
...
//                        Toast.makeText(MatchTheFollowing.this, Character.toString(s2), Toast.LENGTH_SHORT).show();
    ...
    public void levelSet(int chapter ){
        ...
        img2.setTag("three2");
        img3.setText("कपड़े");
        img3.setTag("tracksui3");
        img4.setText("सूरज");
        img4.setTag("sun4");
        img5.setText("सेब");
        img5.setTag("apple5");

        img6.setImageResource(R.drawable.sun);
        img6.setTag("sun6");
        img7.setImageResource(R.drawable.apple);
        img7.setTag("apple7");
        img8.setImageResource(R.drawable.rain);
        img8.setTag("rain8");
        img9.setImageResource(R.drawable.tracksui);
        img9.setTag("tracksui9");
...
//        Toast.makeText(this, "Showing Answers ", Toast.LENGTH_SHORT).show();
        ...
        img8.setImageResource(R.drawable.tracksui);
        img9.setImageResource(R.drawable.sun);
        ...
        CountDownTimer count = new CountDownTimer(10000, 10000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Toast.makeText(MatchHindiChapThree.this, "Going Back in 10 Sec", Toast.LENGTH_LONG).show();
