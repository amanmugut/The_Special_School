...
public class ProfileCreationActivity extends AppCompatActivity {
    ...
    String[] grade = {"Select Your Class", "1"};
    String[] language = {"Preferred Language", "English"};
    String[] disability = {"Select Ability Of Your Disability", "Blind", "Deaf", "Voiceless", "Cerebral Palsy", "Dyslyexia", "Blind , Voiceless", "Deaf , Voiceless"};
                    ...
                    .addOnSuccessListener(
                            new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(
                                    ...
                                    //Toast.makeText(ProfileCreationActivity.this,"Image Uploaded!!",Toast.LENGTH_SHORT).show();
