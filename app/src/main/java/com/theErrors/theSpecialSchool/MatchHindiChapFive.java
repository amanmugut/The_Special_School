...
public class MatchHindiChapFive extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_hindi_chap_five);
...
//                        Toast.makeText(MatchTheFollowing.this, Character.toString(s2), Toast.LENGTH_SHORT).show();
    ...
    public void levelSet(int chapter ){
        ...
        img1.setText("ताली");
        img1.setTag("tali1");
        img3.setText("चंद्रमा");
        img3.setTag("chand3");
        img5.setText("चाकू");
        img5.setTag("chakoo5");
        img8.setImageResource(R.drawable.knife);
        img8.setTag("chakoo8");
        img9.setImageResource(R.drawable.moon);
        img9.setTag("chand9");
        img7.setImageResource(R.drawable.carrot);
        img7.setTag("gajar7");
        img6.setImageResource(R.drawable.berry);
        img6.setTag("fal6");
        img10.setImageResource(R.drawable.clapp);
        img10.setTag("tali0");
...
// 1-6,2-7,3-8,4-9,5-10
        img6.setImageResource(R.drawable.clapp);
        img7.setImageResource(R.drawable.carrot);
        img8.setImageResource(R.drawable.moon);
        img9.setImageResource(R.drawable.berry);
        img10.setImageResource(R.drawable.knife);
        ...
        CountDownTimer count = new CountDownTimer(10000, 10000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Toast.makeText(MatchHindiChapFive.this, "Going Back in 10 Sec", Toast.LENGTH_LONG).show();
