...
public class MatchHindiChapTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_hindi_chap_two);
...
//                        Toast.makeText(MatchTheFollowing.this, Character.toString(s2), Toast.LENGTH_SHORT).show();
    ...
    public void levelSet(int chapter ){
        ...
        img6.setImageResource(R.drawable.peacock);
        img6.setTag("peacock6");
        img7.setImageResource(R.drawable.bee);
        img7.setTag("bee7");
        img8.setImageResource(R.drawable.palm);
        img8.setTag("palm8");
        img9.setImageResource(R.drawable.mango);
        img9.setTag("mango9");
        img10.setImageResource(R.drawable.rabbit);
        img10.setTag("rabbit0");
...
//        Toast.makeText(this, "Showing Answers ", Toast.LENGTH_SHORT).show();
        ...
        img6.setImageResource(R.drawable.mango);
        img7.setImageResource(R.drawable.peacock);
        img8.setImageResource(R.drawable.rabbit);
        img9.setImageResource(R.drawable.bee);
        img10.setImageResource(R.drawable.palm);
        ...
        CountDownTimer count = new CountDownTimer(10000, 10000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Toast.makeText(MatchHindiChapTwo.this, "Going Back in 10 Sec", Toast.LENGTH_LONG).show();
