...
//    String subject[] = {"Hindi", "Mathematics", "English Language"};
    RecyclerView rvHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                int clss = Integer.parseInt(snapshot.child("Class").getValue().toString());
                String disablility = snapshot.child("Disability").getValue().toString();
//                if (!disablility.equals("Blind") || !disablility.equals("Blind , Voiceless")) {
...
//                    subject.add("");
                ...
                if (clss == 3 || clss == 4 || clss == 5) {
                    subject.add("English");
                    subject.add("Mathematics");
                    subject.add("Hindi");
                    subject.add("Environmental Studies");
                }
                HomeAdapter ha = new HomeAdapter();
                rvHome.setAdapter(ha);
                rvHome.setLayoutManager(new GridLayoutManager(getApplicationContext(), 1));
