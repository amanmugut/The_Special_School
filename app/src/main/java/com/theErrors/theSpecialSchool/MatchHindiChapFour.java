...
public class MatchHindiChapFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_hindi_chap_four);
...
//                        Toast.makeText(MatchTheFollowing.this, Character.toString(s2), Toast.LENGTH_SHORT).show();
    ...
    public void levelSet(int chapter ){
        ...
        img6.setImageResource(R.drawable.hands);
        img6.setTag("hands6");
        img7.setImageResource(R.drawable.cookie);
        img7.setTag("cookie7");
        img8.setImageResource(R.drawable.house);
        img8.setTag("house8");
        img9.setImageResource(R.drawable.chair);
        img9.setTag("chair9");
        img10.setImageResource(R.drawable.plate);
        img10.setTag("plate0");
...
//        Toast.makeText(this, "Showing Answers ", Toast.LENGTH_SHORT).show();
        ...
        img6.setImageResource(R.drawable.cookie);
        img7.setImageResource(R.drawable.house);
        img8.setImageResource(R.drawable.chair);
        img9.setImageResource(R.drawable.plate);
        img10.setImageResource(R.drawable.hands);
        ...
        CountDownTimer count = new CountDownTimer(10000, 10000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                Toast.makeText(MatchHindiChapFour.this, "Going Back in 10 Sec", Toast.LENGTH_LONG).show();
